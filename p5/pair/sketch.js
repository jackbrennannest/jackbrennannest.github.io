  ...
  for (let i = 0; i <= brick.length - 1; i++)
    {
        ...
        if(bubble1Y + 25 <= brick[i].y + 2 && bubble1Y + 25 >= brick[i].y - 2 && bubble1X <= brick[i].x + 80 && bubble1X >= brick[i].x){
           motiony *= -1;
          brick[i].c += -50
          if (brick[i].c == 105){
              brick.splice(i, 1)
        ...
        else if(bubble1Y - 25 >= brick[i].y + 28 && bubble1Y - 25 <= brick[i].y + 32 && bubble1X <= brick[i].x + 80 && bubble1X >= brick[i].x)
        {
         motiony *= -1;
          brick[i].c += -50
          if (brick[i].c == 105){
        ...
        else if(bubble1X + 25 >= brick[i].x - 2 && bubble1X + 25 <= brick[i].x + 2 && bubble1Y >= brick[i].y - 5 && bubble1Y <= brick[i].y + 33)
        {
          motionx *= -1;
          brick[i].c += -50
          if (brick[i].c == 105){
        ...
        else if(bubble1X - 25  <= brick[i].x + 81 && bubble1X - 25 >= brick[i].x + 77 && bubble1Y >= brick[i].y - 5 && bubble1Y <= brick[i].y + 33)
        {
          motionx *= -1;
          brick[i].c += -50
          if (brick[i].c == 105){
